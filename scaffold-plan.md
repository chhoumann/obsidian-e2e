...
- [ ] `T3` Add tsdown build config and package export map
  - depends_on: [`T1`]
- [ ] `T4` Define shared public types and low-level transport/client contracts
  - depends_on: [`T1`]
- [ ] `T5` Implement core transport, command execution, and wait utilities
  - depends_on: [`T4`]
...
## Status
- In progress: `T1`
- Pending: `T2`, `T3`, `T4`, `T5`, `T6`, `T7`, `T8`, `T9`, `T10`, `T11`, `T12`, `T13`
